...
async function deleteMedia(id){
  ...
  const r=await sb.functions.invoke('admin-delete-media',{body:{media_id:id}});
  if(r.error)return notice('Could not delete media: '+(r.error.message||'Unknown error'));
  if(r.data?.error)return notice('Could not delete media: '+r.data.error);
