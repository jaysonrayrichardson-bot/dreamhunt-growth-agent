...
function renderAIResult(data){
 ...
 document.getElementById('aiOpenQueue').onclick=()=>{modal.classList.remove('open');showSection('dashboard');setTimeout(()=>document.getElementById('agentQueue')?.scrollIntoView({behavior:'smooth'}),100)};
}
